...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-8o3ir$octzeu*35k2#u+65$!oq&2$iuc6&2odced1x#f9az18_')
...
INTERNAL_IPS = config('ALLOWED_HOSTS', default='192.168.18.15,localhost,127.0.0.1', cast=Csv())
